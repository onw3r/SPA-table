...
function InputSearch(props){
    function setPage(e){                    // возваращает значение инпута и устанавливает первую страницу после поиска, чтобы избежать отображения пустой страницы
    ...
    return (
        <div className='wrapper-input'>
                <input placeholder='Поиск' onChange={(e) => setPage(e)}/>
